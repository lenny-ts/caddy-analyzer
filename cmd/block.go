...
var blockNotify auditNotifyFlags
...
`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		blockNotify.auditLog = blockAuditLog
		dispatcher, err := blockNotify.dispatcher()
		if err != nil {
			return err
		}
		...
		for _, ip := range args {
			...
			dispatcher.Log("block", ip, "manual block", "permanent")
			if blockStateFile != "" {
